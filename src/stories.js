const animalStories = [
  {
    id: 1,
    title: "Ο Σκύλος που Έσωσε την Οικογένειά του",
    content:
      "Ένας πιστός σκύλος ανακάλυψε έναν κρυμμένο επικίνδυνο φυσικό κίνδυνο και προειδοποίησε την οικογένειά του, σώζοντάς τους.",
    tags: ["Σκύλος", "Ήρωας", "Σωτηρία"],
  ...
  },
  {
    ...
    tags: ["Βόδια", "Συνεργασία", "Επιτυχία"],
  ...
  },
  {
    ...
    tags: ["Σκαντζόχοιρος", "Εξερεύνηση", "Περιπέτεια"],
  ...
  },
  {
    ...
    tags: ["Δελφίνι", "Παιχνίδι", "Χαμόγελα"],
